...
class ShowManuCoffeeCoolUI extends StatefulWidget {
  ...
  @override
  State<ShowManuCoffeeCoolUI> createState() => _ShowManuCoffeeCoolUIState();
}

class _ShowManuCoffeeCoolUIState extends State<ShowManuCoffeeCoolUI> {
  @override
