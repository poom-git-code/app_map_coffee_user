...
class StarFourUI extends StatefulWidget {

  String? Email;

  StarFourUI(this.Email);

  @override
  State<StarFourUI> createState() => _StarFourUIState();
}

class _StarFourUIState extends State<StarFourUI> {
  @override
