...
class StarFiveUI extends StatefulWidget {

  String? Email;

  StarFiveUI(this.Email);

  @override
  State<StarFiveUI> createState() => _StarFiveUIState();
}

class _StarFiveUIState extends State<StarFiveUI> {
  @override
