...
class ShowManuCoffeeMoldUI extends StatefulWidget {
  ...
  @override
  State<ShowManuCoffeeMoldUI> createState() => _ShowManuCoffeeMoldUIState();
}

class _ShowManuCoffeeMoldUIState extends State<ShowManuCoffeeMoldUI> {
  @override
