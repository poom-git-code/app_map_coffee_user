...
class StarTwoUI extends StatefulWidget {
  String? Email;

  StarTwoUI(this.Email);

  @override
  State<StarTwoUI> createState() => _StarTwoUIState();
}

class _StarTwoUIState extends State<StarTwoUI> {
  @override
